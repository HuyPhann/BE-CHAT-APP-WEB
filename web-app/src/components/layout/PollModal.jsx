...
const PollModal = ({
    ...
    try {
      ...
      if (isCurrentlyVoted) {
        const response = await axios.post(
          "http://localhost:5000/api/messages/remove-vote",
          {
            messageId: poll._id,
            userId: currentUserId,
            optionIndex,
        ...
        const response = await axios.post(
          "http://localhost:5000/api/messages/vote-poll",
          {
            messageId: poll._id,
            userId: currentUserId,
            optionIndex,
  ...
  const handleAddOption = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/api/messages/add-poll-option",
        {
          messageId: poll._id,
  ...
  const handleEndPoll = async () => {
    try {
      const response = await axios.post(
        "http://localhost:5000/api/messages/end-poll",
        {
          messageId: poll._id,
        }
      );
